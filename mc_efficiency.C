...
/*
  ...
  mc_efficiency("./outputTreesMC/mc_tree_all.dat", "./outputEff/mc_Eff_16Feb.root", 0)

  mc_efficiency("./outputTreesMC/mc_tree_pp17j_pp18i_omega.root", "./outputEff/mc_Eff_16feb_injected.root", 0)
